...
var Select = function (_React$Component) {
	...
	babelHelpers.createClass(Select, [{
		...
		value: function setInputValue(newValue) {
			if (this.props.onInputChange) {
				...
				if (nextState != null && (typeof nextState === 'undefined' ? 'undefined' : babelHelpers.typeof(nextState)) !== 'object') {
					newValue = '' + nextState;
				}
			}
			this.setState({
   ...
   */
		...
		value: function getValueArray(value) {
			...
			var props = (typeof nextProps === 'undefined' ? 'undefined' : babelHelpers.typeof(nextProps)) === 'object' ? nextProps : this.props;
			if (props.multi) {
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			var ariaOwns = classNames((_classNames = {}, babelHelpers.defineProperty(_classNames, this._instancePrefix + '-list', isOpen), babelHelpers.defineProperty(_classNames, this._instancePrefix + '-backspace-remove-message', this.props.multi && !this.props.disabled && this.state.isFocused && !this.state.inputValue), _classNames));
			...
			var inputProps = babelHelpers.extends({}, this.props.inputProps, {
			...
			if (this.props.disabled || !this.props.searchable) {
				var divProps = babelHelpers.objectWithoutProperties(this.props.inputProps, []);


				var _ariaOwns = classNames(babelHelpers.defineProperty({}, this._instancePrefix + '-list', isOpen));
				return React.createElement('div', babelHelpers.extends({}, divProps, {
					'aria-expanded': isOpen,
					'aria-owns': _ariaOwns,
					'aria-activedescendant': isOpen ? this._instancePrefix + '-option-' + focusedOptionIndex : this._instancePrefix + '-value',
			...
			if (this.props.autosize) {
				return React.createElement(AutosizeInput, babelHelpers.extends({ id: this.props.id }, inputProps, { minWidth: '5' }));
			}
			return React.createElement(
				'div',
				{ className: className, key: 'input-wrap', style: { display: 'inline-block' } },
				React.createElement('input', babelHelpers.extends({ id: this.props.id }, inputProps))
			);
		}
	}, {
		key: 'renderClear',
