...
var Select = function (_React$Component) {
   ...
   */
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			var ariaOwns = classNames((_classNames = {}, _defineProperty(_classNames, this._instancePrefix + '-list', isOpen), _defineProperty(_classNames, this._instancePrefix + '-backspace-remove-message', this.props.multi && !this.props.disabled && this.state.isFocused && !this.state.inputValue), _classNames));
			...
			if (this.props.disabled || !this.props.searchable) {
				...
				var _ariaOwns = classNames(_defineProperty({}, this._instancePrefix + '-list', isOpen));
