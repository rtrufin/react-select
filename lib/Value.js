...
var Value = function (_React$Component) {
	babelHelpers.inherits(Value, _React$Component);

	function Value(props) {
		babelHelpers.classCallCheck(this, Value);

		var _this = babelHelpers.possibleConstructorReturn(this, (Value.__proto__ || Object.getPrototypeOf(Value)).call(this, props));
